...
const Instagram = () => {
  ...
  return (
    <div>
     <div>
      <div className="flex flex-col w-full min-h-[100vh] justify-center items-center md:justify-start md:items-start">
        {/* Leftside */}
        <div className="flex">
          <div className="relative hidden md:block">
            <img
              ...
              alt=""
              className="ml-0 lg:ml-40 xl:ml-60 mt-5 lg:mt-10"
            />
            <div className="absolute top-[45px] lg:top-[65px] md:left-[155px] lg:left-[320px] xl:left-[400px] ">
              <img
                src="https://tazzafood.com/wp-content/uploads/2024/07/screenshot1.png"
                alt=""
              />
              <div className="absolute bottom-[11vh] left-40"></div>
            </div>
          </div>
          {/* RightSide */}
